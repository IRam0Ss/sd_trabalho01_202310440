...
public class TesteSendVUGroup {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("    Confirmacoes de leitura (Status 3) na Alice: " + countStatus3 + " / 2 esperadas");
      if (countStatus3 != 1) {
        throw new RuntimeException("FALHA: Esperado exatamente 1 confirmacao de leitura (Bob)!");
      }
      System.out.println("    >>> SUCESSO PARCIAL: Apenas Bob abriu e expirou sua visualizacao. Ticks na Alice continuam em Status 2 (Branco Puro).");
      ...
      System.out.println("    Confirmacoes de leitura (Status 3) na Alice: " + countStatus3 + " / 2 esperadas");
      if (countStatus3 != 2) {
        throw new RuntimeException("FALHA: Esperado 2 confirmacoes de leitura (Bob e Carol)!");
      }

      System.out.println("    >>> SUCESSO TOTAL: TODOS os membros do grupo (Bob e Carol) abriram e fecharam o pop-up modal!");
      System.out.println("\n==================================================");
